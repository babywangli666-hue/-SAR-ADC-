...
% C_SAR_weight=[weight_ADC(1:end),1];%one side cap weight
...
for i=1:1:len
    ...
    %Sar transfer
    [Dout_sar,V1,V2,V3,V4]=SAR_ADC_vs(Vinp,Vinn,Vref,Vcm,C_SAR_weight,total_CDAC,num_ADC,VC1p,VC2p,VC1n,VC2n,V_noise);
    VC1p = V1;
    VC2p = V2;
    VC1n = V3;
    VC2n = V4;
